 ...
 */
class remembermebox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "rememberme@rememberme";
    public $boxlabel;
    public $depends = array("rememberme");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/rememberme/class/rememberme.class.php";
